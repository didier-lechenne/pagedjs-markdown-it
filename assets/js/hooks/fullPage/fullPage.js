const pathHook ="assets/js/hooks/fullPage/fullPage.css";
...
.recto_verso .pagedjs_page_fullRight .pagedjs_full-spread_container{
//  left: calc(var(--pagedjs-margin-left) *-1  - `+ bleedFull + ` );
}
...
.recto_verso .pagedjs_page_fullLeft .pagedjs_full-spread_container{
  width: calc(var(--pagedjs-pagebox-width) + `+ bleedFull + `* 2);
}
...
.recto_verso .pagedjs_page_fullRight .pagedjs_full-spread_content {
    left: calc((var(--pagedjs-pagebox-width) + 0mm)* -1 + var(--pagedjs-fold));
}
...
.recto_verso .pagedjs_left_page .pagedjs_full-page_content {
 width: calc(var(--pagedjs-pagebox-width) + `+ bleedFull + `*2);
}
...
.recto_verso .pagedjs_right_page .pagedjs_full-page_content {
 width: calc(var(--pagedjs-pagebox-width) + `+ bleedFull + `*2);
 left: calc(var(--pagedjs-margin-left) *-1 - `+ bleedFull + `);
}
